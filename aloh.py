...
7. Целевая функция - максимизация прибыли и снижение запасов.
...
- заказ либо берется, либо отклоняется и не пересматривается
...
- введен класса Product (перечислимый тип с обозначением продуктов) 
...
Основное:
 ...
 - [ ] взять реальные данные за месяц (полученные заказы на месяц, принятые заказы, загрузка производства, остатки продукции в начале и конце месяца)
 - [ ] оценить выигрыши от оптимизации
 - [ ] product ownership / maintainer
...
Построение демо:   
 ...
 - [ ] сделать открытым пакетом и вывести расчеты в ноутбук Colab
